...
// Feature Components
import CampusConnectDashboard2 from "./CampusConnectDashboard2";
...
import EmergencyHelp from "../features/emergency/EmergencyHelp"; // NEW
...
const NAV_SECTIONS = [
  ...
  // NEW: Emergency & Help lives in its own top-level section — explicitly
  // NOT inside "STUDENT TOOLKIT", per spec.
  {
    title: "SAFETY",
    items: [
      { id: "help", label: "Emergency & Help", icon: Siren },
    ],
  },
  {
...
export default function CampusConnectDashboard({ currentUser, onLogout }) {
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      // NEW: Emergency & Help Center — /help, top-level, outside Student Toolkit
      case "help":
